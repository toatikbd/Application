    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="{{ route('requisition.index') }}" class="text-dec-none">
        ...
        <!-- #END# Widgets -->
        <div class="block-header">
            <h2>Master Data <span class="badge bg-blue"></span></h2>
        </div>
        <!-- Widgets -->
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="{{ route('country.create') }}" class="text-dec-none">
                    <div class="info-box bg-pink hover-expand-effect cursor-pointer">
                        <div class="icon">
                            <i class="material-icons">playlist_add_check</i>
                        </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="{{ route('requisition-category.create') }}" class="text-dec-none">
                    <div class="info-box bg-cyan hover-expand-effect cursor-pointer">
                        <div class="icon">
                            <i class="material-icons">help</i>
                        </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <a href="{{ route('unit.create') }}" class="text-dec-none">
                    <div class="info-box bg-blue hover-expand-effect cursor-pointer">
                        <div class="icon">
                            <i class="material-icons">forum</i>
                        </div>
                        <div class="content">
                            ...
                            <div class="number count-to" data-from="0" data-to="{{ $units }}" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </a>
            </div>
