    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb breadcrumb-col-pink breadcrumb-right-align">
                ...
                <li class="active"><i class="material-icons">archive</i> Mechanical, electrical, and plumbing</li>
            </ol>
        </div>
        ...
        <div class="row clearfix">
            ...
            <form action="{{ route('m-e-p.update', $mEP->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="task_title" name="task_title" value="{{ $mEP->task_title }}" class="form-control" placeholder="Enter Task Title">
                                </div>
                            </div>
                            <label for="task_description">Task Description</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="task_description" name="task_description" value="{{ $mEP->task_description }}" class="form-control" placeholder="Please type your Task description in shorthand">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="form-line">
                                                <input type="text" name="task_progress" value="{{ $mEP->task_progress }}" class="form-control" placeholder="10%">
                                            </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="body">
                                ...
                                <div class="form-line custom-live-search">
                                    <select class="form-control show-tick" id="select_project" name="project_id" data-live-search="true">
                                        ...
                                        @foreach($projects as $key => $project)
                                            <option {{ $project->id == $mEP->project_id ? 'selected' : '' }} value="{{ $project->id }}"> {{ $project->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <div class="input-daterange input-group" id="bs_datepicker_range_container">
                                        <div class="form-line">
                                            <input type="text" name="start_date" value="{{ \Carbon\Carbon::parse($mEP->start_date)->format('d-m-Y')}}" class="form-control" placeholder="Date start..." autocomplete="off">
                                        </div>
                                        <span class="input-group-addon">to</span>
                                        <div class="form-line">
                                            <input type="text" name="end_date" value="{{ \Carbon\Carbon::parse($mEP->end_date)->format('d-m-Y')}}" class="form-control" placeholder="Date end..." autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-line custom-live-search">
                                    <select class="form-control show-tick" id="select_worker" name="worker_id" data-live-search="true">
                                        ...
                                        @foreach($workers as $key => $worker)
                                            <option {{ $worker->id == $mEP->worker_id ? 'selected' : '' }} value="{{ $worker->id }}"> {{ $worker->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="checkbox" id="the_end"  name="status" value="1" {{ $mEP->status == true ? 'checked' : '' }} class="filled-in chk-col-red"/>
                                    <label for="the_end">THE END</label>
                                </div>
                            </div>
                            <div class="text-center">
                                <a href="{{ route('m-e-p.index') }}" class="btn btn-danger waves-effect">
