                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="job_title" name="job_title" value="{{ $worker->job_title }}" class="form-control" placeholder="Job Title">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="department_name" name="department" value="{{ $worker->department }}" class="form-control" placeholder="Department Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <div id="preview"></div>
                                    <img src="{{ asset('uploaded/worker/'.$worker->image) }}" alt="{{ $worker->name }}" style="max-width:130px; margin-top: 20px">
                                </div>
                            </div>
